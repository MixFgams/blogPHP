...
<html>
    <body>
        <form method='POST'>
            <label for="art">Entrez le nom du nouvel article à créer :</label>
            <br>
            <input type="text" name="art" id="art" minlength="2" required>
            <br>
            <label for="desc">Décrivez le nouvel article :</label>
            <br>
            <textarea name="desc" id="desc" minlength="2" required></textarea>
            <br>
            <label for="cat">Catégories impliquées (séparées par une virgule) :</label>
            <br>
